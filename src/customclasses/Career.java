...
public enum Career implements Text {
    ...
    CASHIER("Cashier","レジ","レジ","レジ","Reji"),
    OFFICE_CLERK("Office clerk","事務員","じむ いん","ジム イン","Jimu In"),
    MANAGER("Manager","マネージャー","マネージャー","マネージャー","Manējā"),
    WAITER("Waiter","ウェイター","ウェイター","ウェイター","Weitā"),
    SALES_WORKER("Sales worker","セールスワーカー","セールスワーカー","セールスワーカー","Sērusuwākā"),
    ...
    SUPERVISOR("Supervisor","スーパーバイザ","スーパーバイザ","スーパーバイザ","Sūpābaiza"),
    ...
    MECHANIC("Mechanic","メカニック","メカニック","メカニック","Mekanikku"),
    ...
    ENGINEER("Engineer","エンジニア","エンジニア","エンジニア","Enjinia"),
    FITNESS_INSTRUCTOR("Fitness Instructor","フィットネスインストラクター","フィットネスインストラクター","フィットネスインストラクター","Fittonesu Insutorakutā"),
